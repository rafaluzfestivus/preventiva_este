...
export const es: SiteDict = {
  ...
  privacyPolicy: {
    ...
    s1Content:
      'Los datos personales recabados a través de este sitio web son responsabilidad de Preventiva Este. Correo electrónico de contacto: contacto@preventivaeste.com. Teléfono: 637 003 793. Ubicación: Barcelona, Cataluña (Prestamos servicio en toda el Área Metropolitana de Barcelona y Cataluña).',
