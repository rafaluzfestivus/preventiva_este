...
const icons = [
    ...
    <Sparkles key="sp" className="w-8 h-8 text-yellow-500" />,
    <Clock key="cl" className="w-8 h-8 text-yellow-500" />,
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="lg:w-1/3">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            {dict.title1} <br />
                            <span className="text-yellow-400">{dict.title2}</span>
                        </h2>
